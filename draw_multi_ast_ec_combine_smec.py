...
# exp_names = ['feb08_notpeak_random0-6_attention', '']
# exp_names = ['feb08_notpeak_random0-6', '']
exp_names = ['feb04_uppeak_random6-12', '']
...
value_loss, action_loss, dist_loss, _, _ = read_log(exp_names[0])
...
_, _, _, energy, test_acc = read_log(exp_names[0])
# r = -0.01*(np.array(test_acc) + 5e-5 * np.array(energy))
r = -0.01*(np.array(test_acc))
r = r[:500]
