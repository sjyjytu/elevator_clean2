...
import sys
import time
from smec_liftsim.utils import SimulatedTime
from smec_liftsim.utils import formulate_simulation_time, simulation_time_to_str, raw_time_to_str
from smec_liftsim.utils import args_to_string
...
class MansionConfig(object):
    def __init__(self,
                 ...
                 number_of_floors=30,
                 floor_height=4.0,
                 maximum_acceleration=0.8,
                 maximum_speed=2.5,
                 person_entering_time=1.2,
                 door_opening_time=2.0,
                 door_closing_time=2.0,
                 keep_door_open_lag=3.2,
                 door_well_time2=2.0,
                 automatic_door_power=350,
                 standby_power_consumption=100,
                 maximum_capacity=1000,
                 maximum_parallel_entering_exiting_number=1,
                 rated_load=600,
                 net_weight=300,
                 pulley_radius=0.27,
        ...
        self.keep_door_open_lag = keep_door_open_lag
        self.dwell_time2 = door_well_time2
    ...
    def world_time(self):
        if not self._cache_up_to_date:
            self._cache_simulate_time = formulate_simulation_time(self._current_time)
