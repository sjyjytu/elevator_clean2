...
model_index = 111
model.load_state_dict(torch.load(f'./save_models4/model_0{model_index}.pt'))
...
def train():
    ...
    for epoch in range(n_epochs):
        ...
        if train_loss < best_loss:
            ...
            torch.save(model.state_dict(), f'./save_models4/model_{str(model_index + epoch + 1).zfill(4)}.pt')
